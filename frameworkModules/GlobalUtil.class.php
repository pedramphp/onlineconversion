...
class GlobalUtil{
	...
	public static function issetNotEmpty($var, $value="", $type ="object"){
		if($value && $type=="object"){
			
			return (isset($var->$value) && (!empty($var->$value) || $var->$value == 0)) ? $var->$value : null;
		}
		return (!empty($var) || $var == 0) ? $var : null;
	}
};
